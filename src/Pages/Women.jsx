...
const Women = () => {
    ...
    useLayoutEffect(() => {
        fetchdata();
        document.title = "Bravima || Women collection"
    }, [debouncedSearch]);
                ...
                <div className="max-w-7xl mx-auto px-6 mb-12">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                        <div>
                            ...
                            >
                                WOMEN'S <span className="text-gray-400">COLLECTION</span>
                            </motion.h1>
                            <p className="text-gray-500 font-medium">Elegant designs for the modern woman</p>
                        </div>
